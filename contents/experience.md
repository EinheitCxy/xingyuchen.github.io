...
May 2025 – Nov 2025; Jun 2026 – Present
...
- Developed a distributed LLM training system based on Nanotron framework, optimized for biochemical domain data with support for multiple molecular representations and streamlined data cleaning pipelines on data lakes.
- Developed a staged pretraining and supervised fine-tuning (SFT) framework that guides model through different training stages based on token consumption, perplexity, and evaluation set accuracy; implemented end-to-end automation from data loading to checkpointing via custom Dataloader classes.
- Implemented a MoT (Mixture-of-Transformer-Experts) architecture, integrating SigLIP vision encoder, VAE, and Qwen2.5 language model for effective cross-modal information fusion.
